...
```bash
curl -L -o rn-fabricator.1.0.0-beta.3.nupkg \
  https://github.com/gitsametcan/rn-fabricator/releases/download/v1.0.0-beta.3/rn-fabricator.1.0.0-beta.3.nupkg
```
...
```bash
export RN_FABRICATOR_TEMPLATE_SOURCE="https://raw.githubusercontent.com/gitsametcan/rn-fabricator/v1.0.0-beta.3/templates/catalog.fabricator.json"
```

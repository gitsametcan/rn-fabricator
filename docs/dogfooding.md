...
```bash
curl -L -o rn-fabricator.0.5.0-alpha.1.nupkg \
  https://github.com/gitsametcan/rn-fabricator/releases/download/v0.5.0-alpha.1/rn-fabricator.0.5.0-alpha.1.nupkg
```
